...
export default function AppDetails() {
  ...
  if (!app) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4">
        ...
        <h1 className="text-4xl font-bold mt-4">OPPS!</h1>
        <p className="mt-2 text-gray-600">APP NOT FOUND</p>
        <Link to="/apps" className="btn bg-gradient-to-r from-[#632EE3] to-[#9F62F2] text-white mt-6">
          Go Back
        </Link>
      </div>
    );
  ...
  const handleInstall = () => {
    ...
    setTimeout(() =>document.getElementById("install-toast")?.classList.add("hidden"),2000);
  };
  return (
